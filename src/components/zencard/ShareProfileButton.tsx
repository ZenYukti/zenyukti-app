...
import { ShareIcon } from "@/components/zencard/icons";
...
export function ShareProfileButton({
  ...
  return (
    <button
      type="button"
      onClick={handleShare}
      className="flex w-full items-center justify-center gap-2 rounded-md border border-border px-4 py-2.5 text-sm font-medium transition-colors hover:bg-surface"
    >
      {!copied && (
